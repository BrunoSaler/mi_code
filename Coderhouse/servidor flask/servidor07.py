...
@app.route("/tipos-de-request-2") #solo permite el método get
...
@app.route("/tipos-de-request-3", methods=["GET", "POST"])  #aca le digo que permito get y post
...
def tipos_de_request_4():  #aca si es get me pide datos, y si es post me muestra lo que mande
    metodo = request.method
