...
@app.route("/")
def home():     #devuelve un mensaje estilizado, es código HTML
    return """   
                    <!DOCTYPE html>
                <html lang="en">
                <head>
...
@app.route("/segundos") #si pongo 127.0.0.1:8182/segundos hace esto, no hace falta llamar a la función, la llama cuando entro a segundos
def segundos():
