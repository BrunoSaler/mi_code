...
class usuario:
    ...
    def mostrar_datos(self):                                        #metodo 1
        ...
        print(f"Nombre: {self.email}")
        print(f"Nombre: {self.password}")
        print(f"Nombre: {self.nacimiento}")
    
    def __str__(self):                                              #metodo 2
        return self.nombre
...
class base_de_datos:
    ...
    def ingresar_compra(self, email, dict):                         #metodo 4
        self.registro_de_usuarios[email]["compras"]=dict
    ...
    def __str__(self):                                              #metodo 7
        return self.nombre
    
    def __len__(self):                                              #metodo 8
        return len(self.registro_de_usuarios)
    
    def __getitem__(self, email):                                   #metodo 9
...
def ingresar_usuario(email):                                        #ingresa un usuario a la base
    if (registros[email]==False):
        ...
        print("La información ingresada fue:/n")
...
def login(email):                                                   #simula un login, me deja ingresar la contraseña hasta 3 veces                                                                  
    x=0 
...
def entrar_compra(email):                                           #ingresa compras a la base de datos si el usuario existe
    stringaux="si"
    y=1
    dict={}
    while (stringaux=="si"):
        ...
        dict[f"compra {y}"]={"Fecha de compra": fecha_de_compra,
                             "sucursal": sucursal,
                             "producto": producto,
                             "cantidad": cantidad
                             }
