...
```
1. Dentro de la carpeta `proyecto_final/ProyectoFinal` o donde este el manage.py vamos a correr el comando `python manage.py startapp AppCoder` lo cual nos dejará en este estado
```bash
# directorio: ProyectoCoder/ProyectoFinal
